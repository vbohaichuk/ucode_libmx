...
// //    mx_printstr("\n\n----------------MX_BUBBLE_SORT-------------------\n");
// //         int bubble_arr[] =  {68, -20, 2, -6, 8, 53, 79, -30, -25};
// //         mx_printstr("mx_bubble_sort return 20? | "); mx_printint(mx_bubble_sort(bubble_arr, 9)); mx_printstr("\n");
// //         int bubble_arr2[] = {-11, 79, 69, -9, -23, 2, 43, 66, -25, 35, 38, 61, 84, 7, 11};
// //         mx_printstr("mx_bubble_sort return 48? | "); mx_printint(mx_bubble_sort(bubble_arr2, 15)); mx_printstr("\n");
// //         int bubble_arr3[] = {2, 20, 54, 86, 60, 73, 52};
// //         mx_printstr("mx_bubble_sort return 6? | "); mx_printint(mx_bubble_sort(bubble_arr3, 7)); mx_printstr("\n");

// //     mx_printstr("\n\n----------------MX_QUICK_SORT-------------------\n");
// //         int  quicksort_arr1[] = {-23, 19, 10, 22, 33, 19, 39};
// //         int  quicksort_arr2[] = {1, 2, 3, 4, 5, 6};
// //         mx_printstr("mx_quicksort return 3? | "); mx_printint(mx_quicksort(quicksort_arr1, 0, 6)); mx_printstr("\n");
// //         mx_printstr("arr1 is \"-23\" \"10\" \"19\" \"19\" \"22\" \"33\" \"39\" | \n\t");
// //         for (int i = 0; i < 7; i++) {
// //             mx_printstr("\""); mx_printint(quicksort_arr1[i]); mx_printstr("\"");
// //             mx_printstr(" ");
// //         }
// //         mx_printstr("|");
// //         mx_printstr("\n");
// //         mx_printstr("mx_quicksort return 0? | "); mx_printint(mx_quicksort(quicksort_arr2, 0, 5)); mx_printstr("\n");
// //         mx_printstr("arr2 is \"1\" \"2\" \"3\" \"4\" \"5\" \"6\" | \n\t");
// //         for (int i = 0; i < 7; i++) {
// //             mx_printstr("\""); mx_printint(quicksort_arr2[i]); mx_printstr("\"");
// //             mx_printstr(" ");
// //         }
// //         mx_printstr("\n");
